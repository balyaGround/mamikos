...
const PencariKosLogin = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const q = query(
        collection(db, 'akun_pencari_kos'),
        where('email', '==', email),
  ...
  return (
    <div className="vh-100 d-flex align-items-center justify-content-center" style={{ backgroundColor: '#e6f7e6' }}>
      <div className="card p-5 shadow-sm login-card" style={{ width: '400px' }}>
        <h3 className="text-success text-center mb-4">Login sebagai Pencari Kos</h3>
...
export default PencariKosLogin;
